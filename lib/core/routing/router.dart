...
class AppRouter {
  static Route generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      // schedule
      case Routes.scheduleEditDaysScreen:
        page = RootScreenWrapper(
            child: BlocProvider(
          create: (context) => getit<ClinicScheduleUpdateBloc>(),
          child: const ScheduleEditDaysScreen(),
        ));
        break;
      ...
      case Routes.clinicShiftsTimeScreen:
        final args = settings.arguments as ClinicWorkingDayArgs;
        page = RootScreenWrapper(
          child: BlocProvider(
            create: (context) => getit<ClinicShiftBloc>(),
            child: ClinicShiftsTimeScreen(clinicWorkingDayArgs: args),
          ),
        );
        break;
      ...
      case Routes.appointmentDetailsScreen:
        ...
        page = RootScreenWrapper(
            child: BlocProvider(
          create: (context) => getit<AppointmentDetailsBloc>()
            ..add(GetAppointmentDetailsEvent(appointmentId: appointmentId)),
