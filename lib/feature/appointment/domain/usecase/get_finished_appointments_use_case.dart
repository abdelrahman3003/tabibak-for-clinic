...
class GetFinishedAppointmentsUseCase {
  final AppointmentRepo appointmentRepos;

  GetFinishedAppointmentsUseCase({required this.appointmentRepos});
  Future<Either<ApiErrorModel, List<AppointmentEntity>>> call() async {
    final result = await appointmentRepos.getFinishedAppointments();
    return result;
  }
}
